...
const SelectCategory = (select) => {
  return (
    <select>
        ...
        <option value="electronics">Shoes for Men</option>
        <option value="computer">Caps</option>
        <option value="smart-home">Bags</option>
        <option value="automotive">Bottles</option>
